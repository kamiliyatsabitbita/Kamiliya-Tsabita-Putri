...
const contactInfo = [
  {
    icon: Mail,
    label: 'Email',
    value: 'kamiliyatsabita@gmail.com',
    href: 'mailto:kamiliyatsabita@gmail.com',
  },
  {
    icon: Phone,
    label: 'Telepon',
...
export default function ContactSection() {
  ...
  return (
    <section id="contact" className="py-20 bg-gradient-to-b from-pink-200 via-blue-200 to-purple-200">
